...
const FOOTSTEP_PATHS = {
	"GrassArena": [
		"res://assets/game/audio/sfx/footstep.ogg",
		"res://assets/game/audio/sfx/footstep.wav",
		"res://assets/game/audio/sfx/footstep.mp3",
		"res://assets/game/audio/music/footstep.ogg",
		"res://assets/game/audio/music/footstep.wav",
		"res://assets/game/audio/music/footstep.mp3"
	],
	"DesertArena": [
		"res://assets/game/audio/sfx/footstep_desert.ogg",
		"res://assets/game/audio/sfx/footstep_desert.wav",
		"res://assets/game/audio/sfx/footstep_desert.mp3",
		"res://assets/game/audio/music/footstep_desert.ogg",
		"res://assets/game/audio/music/footstep_desert.wav",
		"res://assets/game/audio/music/footstep_desert.mp3"
	],
	"WinterArena": [
		"res://assets/game/audio/sfx/footstep_winter.ogg",
		"res://assets/game/audio/sfx/footstep_winter.wav",
		"res://assets/game/audio/sfx/footstep_winter.mp3",
		"res://assets/game/audio/music/footstep_winter.ogg",
		"res://assets/game/audio/music/footstep_winter.wav",
		"res://assets/game/audio/music/footstep_winter.mp3"
	]
}
...
func add_pollen(amount: float) -> void:
	pollen += amount
	total_pollen_earned += amount
	pollen_collected.emit(amount)
