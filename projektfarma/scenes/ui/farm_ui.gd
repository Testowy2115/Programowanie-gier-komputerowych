...
func _on_roll_button_pressed() -> void:
	...
	var left_marker = create_roll_marker(">", Vector2(roll_container.position.x - 42, marker_y))
	var right_marker = create_roll_marker("<", Vector2(roll_container.position.x + roll_container.size.x + 6, marker_y))
